# 🍩 Donut worry 🍩
> "강의 자료 관리, 과제 확인, 공지사항 체크까지? 이젠 Donut worry!"
> 대학생들의 스마트한 e-Campus 학업 관리를 위한 단축키 기반 휠(Wheel) UI 프로그램입니다.

---

## ✨ 우리가 추구하는 가치 (Our Orientation)
...
### 2. 공지사항 및 과제 요약 (LLM 기반)
* 새로 올라온 공지사항을 유형별, 과목별 분류 기능으로 제공합니다.
* 과제 정보(마감일, 배점, 중요도)를 추출하여 마감 임박 순으로 정렬합니다.

### 3. 미시청 콘텐츠 트래커
* 아직 수강 완료하지 않은 동영상 강의 목록을 추적하여 유저에게 리마인드합니다.

### 4. 성적 시뮬레이터
* 과목별 성적 반영 비율(출석, 과제, 중간, 기말 등)을 학습계획서에서 자동으로 가져와서 현재 점수를 기록하면 최종 예상 총점을 자동 계산합니다.
